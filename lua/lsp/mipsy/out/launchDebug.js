...
exports.setupSendInputButton = exports.setupDebugButton = void 0;
const vscode = require("vscode");
function setupDebugButton(context) {
    context.subscriptions.push(vscode.commands.registerCommand('mips.debug', async (file) => {
        ...
        vscode.debug.startDebugging(undefined, //vscode.workspace.workspaceFolders[0],
        {
            type: 'mipsy-1',
    ...
    const uriToSessionIds = Object.create(null);
...
exports.setupDebugButton = setupDebugButton;
function setupSendInputButton(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('mipsy.debug.sendFileToInput', (uri) => {
        vscode.workspace.openTextDocument(uri).then(document => {
            let text = document.getText();
            vscode.debug.activeDebugSession?.customRequest('queueInput', {
                contents: text
...
exports.setupSendInputButton = setupSendInputButton;
//# sourceMappingURL=launchDebug.js.map